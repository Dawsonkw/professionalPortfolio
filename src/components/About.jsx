        ...
        <div id='about'>
            <div className='flex iphone5:flex-col 350:flex-col mobile:flex-col sm:flex-row  sm:px-4 justify-between  py-4 px-4 mt-10'>
                ...
                <div className='flex w-3/5  mt-4 iphone5:mx-auto xl:mx-8 iphone5:order-2 350:order-2 mobile:order-2 sm:order-1 '>
                    <div className='flex flex-col justify-center items-center bg-bone py-4 px-4 w-full h-full  rounded-xl iphone5:rounded-xl 350:rounded-xl mobile:rounded-xl sm:rounded-tr-none sm:rounded-br-none xl:rounded-xl xl:mr-1 text-xl text-center text-reallyDarkTurquoise font-bold iphone5:text-sm iphone5:w-screen iphone5:ml-8 '>
