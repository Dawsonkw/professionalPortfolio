...
function Technologies(props) {
    return (
        <div>
            <div className='bg-bone p-4 flex flex-col iphone5:m-4 iphone5:my-8 mobile:my-8 sm:my-8 md:my-8 mobile:mx-8 sm:m-2 md:m-4 rounded-xl shadow-md shadow-black'>
                ...
                <div className='grid lg:grid-cols-3 md:grid-cols-2 gap-3 gap-x-6 sm:grid-cols-1 pt-2'>               
                    <div className='bg-gray-300 p-6 my-2 mx-2 relative shadow-sm shadow-black rounded-xl' id='reactCard'>
                    ...
                    <div className='p-6 my-2 mx-2 relative shadow-sm shadow-black  rounded-xl' id='jsCard' >
                    ...
                    <div className='bg-gray-300 p-6 my-2 mx-2 relative shadow-sm shadow-black rounded-xl' id='htmlCard'>
                    ...
                    <div className='bg-gray-300 p-6 my-2 mx-2 relative shadow-sm shadow-black rounded-xl' id='tailwindCard'>
                    ...
                    <div className='bg-gray-300 p-6 my-2 mx-2 relative shadow-sm shadow-black rounded-xl' id='viteCard'>
                    ...
                    <div className='bg-gray-300 p-6 my-2 mx-2 relative shadow-sm shadow-black rounded-xl' id='cCard'>
                    ...
                    <div className='bg-gray-300 p-6 my-2 mx-2 relative shadow-sm shadow-black rounded-xl' id='pythonCard'>
                    ...
                    <div className='bg-gray-300 p-6 my-2 mx-2 relative shadow-sm shadow-black rounded-xl' id='devCard'>
